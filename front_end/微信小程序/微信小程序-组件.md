...
- [微信小程序组件](#微信小程序组件)
  - [一. 视图容器](#一-视图容器)
    ...
    - [1.4 movable-area (movable-view 的可移动区域)](#14-movable-area-movable-view的可移动区域)
    ...
    - [1.8 swiper-item (仅可放置在 swiper 组件中，宽高自动设置为 100%)](#18-swiper-item-仅可放置在swiper组件中宽高自动设置为100)
