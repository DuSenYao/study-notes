...
- [VisualStudioCode](#visualstudiocode)
  ...
  - [四. 插件](#四-插件)
    - [4.1 有趣的插件](#41-有趣的插件)
    - [4.2 插件开发](#42-插件开发)
      - [4.2.1 开发环境及项目结构](#421-开发环境及项目结构)
      - [4.2.2 插件核心实现](#422-插件核心实现)
  - [五. 语言深入](#五-语言深入)
  ...
  - [六. 前端开发](#六-前端开发)
    ...
    - [6.2 CSS/SCSS/Less](#62-cssscssless)
      ...
      - [6.2.6 自定义 CSS 数据格式](#626-自定义-css-数据格式)
    - [6.3 Emmet](#63-emmet)
      ...
      - [6.3.5 自定义 Emmet 片段](#635-自定义-emmet-片段)
    - [6.4 Vue](#64-vue)
      - [6.4.1 调试 Vue](#641-调试-vue)
      - [6.4.2 Vue 设置 VSCode 识别别名](#642-vue-设置-vscode-识别别名)
  - [七. 远程开发](#七-远程开发)
...
> 例：[test.http](./examples/test.http)
...
> 例：[tsconfig.json](./examples/tsconfig.json)
